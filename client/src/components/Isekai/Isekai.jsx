...
function Isekai() {
    ...
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/isekai`
        );
  ...
  return (
    <div className="all_all_isekai_category">
      <div className="title_synopsis_container">
        <div className="title_synopsis_category">
          <h1>Isekai</h1>
          <p>
            Des protagonistes sont transportés de notre monde à un autre monde
            fantastique, où ils doivent sadapter et souvent jouer un rôle
            crucial dans ce nouveau monde.
          </p>
        </div>
      </div>

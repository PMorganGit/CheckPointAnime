...
function SliceOfLife() {
    ...
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/sliceoflife`
        );
  ...
  return (
    <div className="all_all_slice_category">
      <div className="title_synopsis_container">
        <div className="title_synopsis_category">
          <h1>Slice of Life</h1>
          <p>
            Scènes quotidiennes de la vie quotidienne, souvent avec un accent
            sur les relations humaines et les émotions.
          </p>
        </div>
      </div>

...
function Fantasy() {
    ...
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/fantasy`
        );
  ...
  return (
    <div className="all_all_fantasy_category">
      <div className="title_synopsis_container">
        <div className="title_synopsis_category">
          <h1>Fantasy</h1>
          <p>
            La Fantasy dans les mangas et animés plonge les spectateurs dans des
            mondes magiques peuplés de créatures mythiques. Ces récits suivent
            des héros dans des quêtes épiques, offrant une évasion captivante où
